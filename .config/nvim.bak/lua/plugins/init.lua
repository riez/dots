local plugins = {
  ...
  ["ThemerCorp/themer.lua"] = {
    -- module = "themer",
    config = function()
      -- require("plugins.configs.others").themer()
  ...
  --   config = function()
  --     -- require("plugins.configs.others").themer()
  --     local present, one_monokai = pcall(require, "one_monokai")
  --     if present then
  --       local options = {
  --         transparent = true,
  --         colors = {},
  ...
  ["akinsho/git-conflict.nvim"] = {
    config = function()
      local present, gitcflct = pcall(require, "git-conflict")
      if present then
        local options = {}
        gitcflct.setup(options)
      end
    end,
  },
